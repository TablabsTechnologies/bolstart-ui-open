(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-perks-perks-module"], {
    ...
    /***/
    function D1sS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PerksService", function () {
        return PerksService;
      });
      /* harmony import */
      ...
      var PerksService = /*#__PURE__*/function () {
        function PerksService(http) {
          _classCallCheck(this, PerksService);

          this.http = http;
          this.baseUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].baseUrl;
        }

        _createClass(PerksService, [{
          key: "redeemPerk",
          value: function redeemPerk(userId, perkName, perkAmount) {
            return this.http.post(this.baseUrl + "perk/user?userId=".concat(userId, "&perkProviderName=").concat(perkName, "&perkAmount=").concat(perkAmount), {});
          }
        }]);
      ...
      PerksService.ɵfac = function PerksService_Factory(t) {
        return new (t || PerksService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]));
      };

      PerksService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: PerksService,
        factory: PerksService.ɵfac,
        providedIn: 'root'
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PerksService, [{
    ...
    /***/
    function DoD1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PerksRoutingModule", function () {
        return PerksRoutingModule;
      });
      /* harmony import */
      ...
      var _perks_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./perks.component */
      "tKA0");

      var routes = [{
        path: '',
        component: _perks_component__WEBPACK_IMPORTED_MODULE_2__["PerksComponent"]
      }];

      var PerksRoutingModule = function PerksRoutingModule() {
        _classCallCheck(this, PerksRoutingModule);
      };

      PerksRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: PerksRoutingModule
      });
      PerksRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        factory: function PerksRoutingModule_Factory(t) {
          return new (t || PerksRoutingModule)();
        },
        imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](PerksRoutingModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PerksRoutingModule, [{
    ...
    /***/
    function ZLU0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PerksModule", function () {
        return PerksModule;
      });
      /* harmony import */
      ...
      var _perks_routing_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./perks-routing.module */
      "DoD1");
      /* harmony import */
      ...
      var PerksModule = function PerksModule() {
        _classCallCheck(this, PerksModule);
      };

      PerksModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
        type: PerksModule
      });
      PerksModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        factory: function PerksModule_Factory(t) {
          return new (t || PerksModule)();
        },
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_0__["CommonModule"], _perks_routing_module__WEBPACK_IMPORTED_MODULE_3__["PerksRoutingModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](PerksModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](PerksModule, [{
    ...
    /***/
    function tKA0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _profile_profile_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _perks_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./perks.service */
      "D1sS");
      /* harmony import */
      ...
      var PerksComponent = /*#__PURE__*/function () {
        function PerksComponent(profileService, toastr, perksService, toast) {
        ...
        _createClass(PerksComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var userId = localStorage.getItem('member');
            this.profileService.getUserInfo(userId, userId).subscribe(function (res) {
              if (res.success) {
          ...
          key: "onRedeem",
          value: function onRedeem(name, price) {
            var _this2 = this;

            if (this.userDetail.company_id != null) {
              this.perksService.redeemPerk(this.userDetail.id, name, price).subscribe(function (res) {
                if (res != "") {
                  _this2.model.nativeElement.click();
                }
              });
            } else {
      ...
      PerksComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 90,
        vars: 0,
        consts: [[1, "container"], [1, "card"], [1, "p-2", "count_class"], [2, "width", "80%"], [1, "text-center"], [1, "text-primary"], [1, "card-body"], ["src", "assets/logo/Logo - White - CometChat.png"], [2, "width", "60%"], [2, "display", "inline"], [1, "amount"], [1, "btn", "btn-primary", "reedem", 3, "click"], ["src", "assets/logo/AWS_Sethu Sathyan.png", 2, "max-width", "12rem"], ["src", "assets/logo/Logo Razorpay - Allan Jose.png", 2, "max-width", "12rem"], ["id", "successModel", "role", "dialog", 1, "modal", "fade"], [1, "modal-dialog", "modal-sm"], [1, "modal-content", "p-3"], [1, "modal-Custheader", "p-2"], ["type", "button", "data-dismiss", "modal", 1, "close"], [1, "modal-title"], [1, "modal-body"], ["hidden", "", "type", "button", "data-toggle", "modal", "data-target", "#successModel", 1, "btn", "btn-primary"], ["model", ""]],
        template: function PerksComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PerksComponent_Template_button_click_37_listener() {
              return ctx.onRedeem("CometChat", "3000");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PerksComponent_Template_button_click_60_listener() {
              return ctx.onRedeem("AWS", "5000");
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PerksComponent_Template_button_click_75_listener() {
              return ctx.onRedeem("Razorpay", "1350");
            });
        ...
        directives: [_shared_header_header_component__WEBPACK_IMPORTED_MODULE_4__["HeaderComponent"]],
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PerksComponent, [{
          ...
          return [{
            type: _profile_profile_service__WEBPACK_IMPORTED_MODULE_1__["ProfileService"]
          }, {
            type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"]
          }, {
            type: _perks_service__WEBPACK_IMPORTED_MODULE_3__["PerksService"]
          }, {
            type: ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"]
          }];
        }, {
...
//# sourceMappingURL=components-perks-perks-module-es5.js.map